 ...
 *
 * Return: Positive byte difference if s1 greater than s2
 *         0 if s1 equals s2
 ...
 * @deck: A pointer to the deck's head
 */
...
/**
 * insertion_sort_deck_value - Sort a deck of cards sorted from S to D
 *                             from ace to king.
 * @deck: A pointer to the deck's head
 */
